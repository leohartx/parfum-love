...
class Ess_M2ePro_Block_Adminhtml_Listing_Product_Variation_Manage
    extends Ess_M2ePro_Block_Adminhtml_Listing_Product_Variation
{
    //##############################################################
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/listing/product/variation/manage.phtml');
    }
    ...
    protected function _prepareButtons()
    {
        ...
        $buttonBlock = $this->getLayout()
            ->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('M2ePro')->__('Generate All'),
                'onclick' => $onClick,
                'class' => 'button',
        ...
        $buttonBlock = $this->getLayout()
            ->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('M2ePro')->__('Generate Unique'),
                'onclick' => $onClick,
                'class' => 'button',
