<?php
class IVVYRU_ConfDefault_Model_Product_Type_Configurable extends Mage_Catalog_Model_Product_Type_Abstract
{
    ...
    public function getConfigurableAttributesAsArray($product = null)
    {
        ...
        foreach ($this->getConfigurableAttributes($product) as $attribute) {
            $res[] = array(
                ...
                'super_super_attribute_id' => $attribute->getSuperDefault(),
            );
        }
        return $res;
    }
